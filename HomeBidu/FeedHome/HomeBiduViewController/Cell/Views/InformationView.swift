...
class InformationView: UIView {
    ...
    private lazy var nameLabel: UILabel = {
        ...
        name.font = UIFont(name: K.Fonts.lexendSemiBold.rawValue, size: 16.0)
    ...
    private lazy var famousImageView: UIImageView = {
        ...
        famous.image = #imageLiteral(resourceName: "famous")
    ...
    private lazy var followButton: UIButton = {
        let follow = UIButton()
        follow.setImage(#imageLiteral(resourceName: "+"), for: .normal)
    ...
    private lazy var activeLabel: UILabel = {
        ...
        active.font = UIFont(name: K.Fonts.josefinSansRegular.rawValue, size: 13.0)
    ...
    private lazy var statusLabel: UILabel = {
        ...
        status.font = UIFont(name: K.Fonts.lexendRegular.rawValue, size: 14.0)
    ...
    private lazy var hagtagLabel: UILabel = {
        ...
        hagtag.font = UIFont(name: K.Fonts.lexendRegular.rawValue, size: 10.0)
...
extension InformationView: FetchableImage {
    func setupUI(with feedInformation: FeedPostModel){
